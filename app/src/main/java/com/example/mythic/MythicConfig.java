...
public class MythicConfig {
    public static final String MYTHIC_SERVER_URL = "PASTE_YOUR_MYTHIC_SERVER_URL_HERE";
    public static final String OPENAI_API_KEY = "PASTE_YOUR_OPENAI_API_KEY_HERE";
    ...
    public static boolean hasServerUrl() {
        return MYTHIC_SERVER_URL != null
                ...
                && !"PASTE_YOUR_MYTHIC_SERVER_URL_HERE".equals(MYTHIC_SERVER_URL);
    }
